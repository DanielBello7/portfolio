...
const projects = [
  ...
  },
  {
    ...
    desc: `The web application find is a search engine system that was built with TailwindCSS and React and Typescript and uses Heroku as the backend`,
    more: `It is an application that allows a user to upload raw data in JSON format and run a search for anything and if it’s within the data being provided.`,
    role: 'Full-Stack',
    img: assets.finder_1,
  ...
  },
  {
    ...
    desc: `This is a front-end mobile application created with react native and was deployed on the Expo servers. Hasn’t been deployed to the App Store or Google Play store.`,
    more: null,
    role: 'Front-end',
    img: assets.nft_1,
  ...
  },
  {
    ...
    tags: ['React Native', 'Typescript'],
    desc: `This is a frontend mobile application for a quick sharing of goods and services that connects goods owners to people in search of those goods and services.`,
    more: `Uses ReactJS and is hosted on Heroku.`,
    role: 'Front-end',
