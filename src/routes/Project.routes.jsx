                    ...
                    <div className='col-12 col-md-12 col-lg-4 d-flex flex-column'>
                        ...
                        <Fade triggerOnce delay={600}>
                            <div className='d-flex flex-row my-5'>
                                ...
                                <a className='btn btn-outline-dark px-4 d-flex flex-row align-items-center ms-2' href={project.repo} target="_blank" onClick={() => !project.repo && ToggleToast(true, 'Currently unavailable', false)}>
